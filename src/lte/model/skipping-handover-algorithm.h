...
#ifndef SKIPPING_HANDOVER_ALGORITHM_H
#define SKIPPING_HANDOVER_ALGORITHM_H
 ...
 */
class SkippingHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  SkippingHandoverAlgorithm ();

  virtual ~SkippingHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<SkippingHandoverAlgorithm>;
...
private:
  ...
  //Number of UEs in the simulation, will be passed as algorithm parameter
  uint16_t m_numberOfUEs;
  /// Interface to the eNodeB RRC instance.
  LteHandoverManagementSapUser* m_handoverManagementSapUser;
  /// Receive API calls from the eNodeB RRC instance.
  LteHandoverManagementSapProvider* m_handoverManagementSapProvider;

}; // end of class SkippingHandoverAlgorithm
