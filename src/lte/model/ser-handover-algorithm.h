...
#ifndef SER_HANDOVER_ALGORITHM_H
#define SER_HANDOVER_ALGORITHM_H
 ...
 */
class SerHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  SerHandoverAlgorithm ();

  virtual ~SerHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<SerHandoverAlgorithm>;
...
}; // end of class SerHandoverAlgorithm
