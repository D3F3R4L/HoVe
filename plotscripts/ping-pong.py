...
def main():
    if (len(sys.argv) == 1):
        print("Passar arquivo ou parâmetro\n--help para listar comandos")

    elif(sys.argv[1] == "--help"):
        print("Script para contabilizar o total de handover Ping-Pong\nlista de comandos\n\t--help - ajuda\n\t--test - calcular com uma matriz de testes")
        ...
        print(findPP(parseRun(sys.argv[1])))
